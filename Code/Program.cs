...
string Zad2_1_word_encrypted = new MatrixShift(key: Zad2_0_key).Encrypt(Zad2_2_word).CollectString();
Console.WriteLine(Zad2_1_word_encrypted);
string Zad2_1_word_encrypted_decrypted = new MatrixShift(key: Zad2_0_key).Decrypt(Zad2_1_word_encrypted).CollectString();
